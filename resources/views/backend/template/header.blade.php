  ...
  <div class="navbar navbar-default">
    <div class="navbar-header">
      <a class="navbar-brand navbar-brand-center" href="index.html">
        <img class="navbar-brand-logo" src="{{ App\Http\Controllers\Controller::getLogoUrl() }}" alt="Elephant">
      </a>
      ...
      <button class="navbar-toggler visible-xs-block collapsed" type="button" data-toggle="collapse" data-target="#navbar">
        ...
        <span class="ellipsis ellipsis-vertical">
          <img class="ellipsis-object" width="32" height="32" src="{{ asset('backend/img/0180441436.jpg') }}" alt="{{ Auth::user()->name }}">
        </span>
      </button>
    </div>
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="dropdown hidden-xs">
            <button class="navbar-account-btn" data-toggle="dropdown" aria-haspopup="true">
              <img class="rounded" width="36" height="36" src="{{ asset('backend/img/0180441436.jpg') }}" alt="{{ Auth::user()->name }}"> {{ Auth::user()->name }}

...
@section('title', 'Edit F.A.Q')
@section('title-bar-title', 'Edit F.A.Q')
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="demo-form-wrapper">
            <form data-toggle="validator" class="form form-horizontal" action="{{ route('faq.update', $faq->id) }}" method="post">
              {{ csrf_field() }}
              {{ method_field('PUT') }}
              <div class="form-group">
                ...
                <div class="col-sm-2">
                  <select class="form-control" name="status">
                    ...
                    <option value="disabled" {{ $faq->status == 'disabled' ? 'selected':'' }}>Disabled</option>
                  </select>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input name="name" value="{{ $faq->name }}" class="form-control" type="text" required>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <textarea name="value" class="form-control editor" rows="8" cols="80" required>{{ $faq->value }}</textarea>
                </div>
              </div>

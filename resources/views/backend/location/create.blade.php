...
@section('title-bar-title', 'Add New Location')
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="demo-form-wrapper">
            <form data-toggle="validator" class="form form-horizontal" action="{{ route('location.store') }}" method="post">
              {{ csrf_field() }}
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <textarea name="google_map_address" class="form-control" rows="3" required></textarea>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <textarea name="google_map_embed" class="form-control" rows="3" required></textarea>
                </div>
              </div>
